...
if [ -f frameworks/base/core/xsd/vts/Android.mk ]; then	# if [ -f frameworks/base/core/xsd/vts/Android.mk ]; then
    rm -rf frameworks/base/core/xsd/vts/Android.mk && touch frameworks/base/core/xsd/vts/Android.mk	#     rm -rf frameworks/base/core/xsd/vts/Android.mk && touch frameworks/base/core/xsd/vts/Android.mk
fi
